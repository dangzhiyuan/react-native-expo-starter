...
const HighTrackView: React.FC<{
  ...
  console.log("HightrackView,HightrackViewHightrackViewHightrackViewHightrackViewHightrackView,HightrackViewHightrackView");
