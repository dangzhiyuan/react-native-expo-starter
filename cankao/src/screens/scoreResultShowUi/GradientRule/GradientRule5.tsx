...
const GradientRule5 = ({ data }) => {
  ...
  function calculateLeftStyle(result, data_up_boundary, data_down_boundary) {
    ...
    if (result <= data_up_boundary) {
      return "-80%";
    }
    if (result == data_down_boundary) {
      return "80%";
    }
    if (result > data_down_boundary) {
      return "410%";
    ...
    //   return (
    //     (((result - l) / (data_up_boundary - l)) * 160 - 80).toString() + "%"
    //   );
    // }
    ...
    //   return (
    //     (
    //       ((result - data_down_boundary) / (r - data_down_boundary)) * 200 +
    //       210
    //     ).toString() + "%"
    //   );
    // }
      ...
      >
        ...
        >
          ...
          <View style={styles.separatorContainer}>
            ...
            {/* <View style={[styles.separator1, { left: "150%" }]}>
              <Text style={styles.separatorText}>
